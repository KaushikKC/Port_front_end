  ...
  return (
    ...
    <div className='flex flex-col w-[700px] rounded-xl bg-[#DBEFF9] m-[30px]  h-[900px]'>
      <div onClick={() => handleBack()}>
        ...
        <div className='flex justify-center'>
            <p className='text-[40px]'>Create Hangout</p>
        </div>
        <div className='p-[20px]'>
            <img class="h-32 w-32 rounded-full border-4 border-white  mx-auto my-4" src={profile} alt="Profile" />
            ...
            <div className='flex justify-center my-[20px]'>
              <button type='submit' className='bg-[#2DA2B5] p-[10px] rounded-3xl text-white  w-[200px] flex justify-center hover:font-medium'>Change Profile</button>
            </div>
        </div>
    </div>
  )
